  ...
  return (
    <>
      ...
      <section className="lg:bg-amcovad-primary-500 overflow-hidden min-h-screen">
        <div className="flex    bg-cover bg-[url('../assets/images/md-hexagons.png')] bg-top bg-opacity-20 lg:bg-[url('../assets/images/hexagons.png')]">
          <div className="flex flex-col justify-center flex-1 px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 ">
            <div className="w-full max-w-[43rem] lg:w-[38rem]  mx-auto pt-20 lg:pt-0 ">
          ...
          <div className="relative lg:flex flex-1 hidden lg:w-screen lg:h-screen bottom-0 ">
            <Image src={SignUpImage} alt=" Sign up image" />
            {/* <Image src="/assets/images/signup.png" width="100%" height="100%" alt="side up " /> */}
          </div>
        </div>
      </section>
    </>
